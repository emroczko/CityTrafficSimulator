...
namespace ZPR {
    ...
    void CreatorState::Init(){
        ...
        this->_manageCamerasView = sf::View(sf::FloatRect(0.f, 0.f, static_cast<float>(this->_data->window.getSize().x/4), static_cast<float>(this->_data->window.getSize().y)));
        this->_manageCamerasView.setViewport(sf::FloatRect(0, 0.f, 0.3, 1.f));
        
        this->_creatorView = sf::View(sf::FloatRect(0.f, 0.f, static_cast<float>(this->_data->window.getSize().x/2), static_cast<float>(this->_data->window.getSize().y)));
        this->_creatorView.setViewport(sf::FloatRect(0.18, 0.f, 0.8, 1.f));
        ...
        this->_creatorToolsView.setViewport(sf::FloatRect(0.2, 0.f, 0.8, 1.f));
